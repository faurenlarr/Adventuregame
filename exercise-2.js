...
// Put your answer below -------------------------
option C : z then y
the letter is x, so when you run the function, it prints out z first because it has no setTimeout, and the computer is waiting on y to print out after one second.
